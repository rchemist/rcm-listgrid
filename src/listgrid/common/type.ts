...
export type AdditionalColorType = 'dark' | 'gray' | 'red' | 'pink' | 'grape' | 'violet' | 'indigo' | 'blue' | 'cyan'
  | 'green' | 'lime' | 'yellow' | 'orange' | 'teal' | 'black'| 'white';
...
export const ColorTypes: ColorType[] = ['primary', 'info', 'success', 'warning', 'danger', 'secondary', 'dark'];

export const AdditionalColorTypes: AdditionalColorType[] = ['dark', 'gray', 'red', 'pink', 'grape', 'violet', 'indigo', 'blue', 'cyan', 'green', 'lime', 'yellow', 'orange', 'teal', 'black', 'white'];

export const AllColorTypes: (ColorType | AdditionalColorType)[] = [...ColorTypes, ...AdditionalColorTypes];

export const VariantTypes: VariantType[] = ['filled', 'outline', 'solid'];

export const ShapeTypes: ShapeType[] = ['pill', 'box', 'rounded'];

export const SizeTypes: SizeType[] = ['xs', 'sm', 'md', 'lg', 'xl', '2xl', '3xl', '4xl', '5xl', '6xl', 'full'];