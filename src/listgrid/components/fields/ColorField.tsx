...
async function renderColorListField(field: ColorField, props: ViewListProps): Promise<ViewListResult> {
...
const ColorInputField = ({name, label, required = false, readonly = false, withAlpha = false, ...props}: ColorInputFieldProps) => {
  ...
  return <ColorInput
    ...
    format={'hex'}
    swatches={['#2e2e2e', '#868e96', '#fa5252', '#e64980', '#be4bdb', '#7950f2', '#4c6ef5', '#228be6', '#15aabf', '#12b886', '#40c057', '#82c91e', '#fab005', '#ffffff']}
    disabled={readonly}
    withAlpha={withAlpha}
  />
}