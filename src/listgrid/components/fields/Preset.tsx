...
export const AvailableDatetimeFields = (target: string, props?: AvailableDatetimeFieldProps): DatetimeField[] => {
...
export const StatusDateAndRevisionPreset = (useUpdatedAt: boolean = true, useRevision: boolean = true): AddFieldItemProps => {
...
export const StatusCreatedAtFieldPreset: AddFieldItemProps = StatusDateAndRevisionPreset(false, true);

export const StatusCreatedAndUpdatedAtFieldPreset: AddFieldItemProps = StatusDateAndRevisionPreset(true, true);
...
export const DiscardedPublishStatusTypes: SelectOption[] = [
  { label: '폐기', value: 'DISCARDED' },
];
...
export function applyPublishStatusEntityForm(entityForm: EntityForm, ...readonlyOnPublishedFields: string[]): EntityForm {
