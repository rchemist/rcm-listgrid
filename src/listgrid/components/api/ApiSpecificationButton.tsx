...
export const ApiSpecificationButton = ({apiSpec}: {apiSpec?: ApiSpecification | ReactNode}) =>  {
  ...
  return <div className={'ml-2'}>
    <button className={'btn-outline-info rounded-full w-[24px] h-[24px]'} onClick={() => setOpen(true)}>
    ...
    {open && <>
      <Modal opened={open}
        ...
        {isApiSpecification(apiSpec) ? <ViewApiSpecification {...apiSpec} /> : apiSpec as ReactNode}
      </Modal>
    </>}
  </div>
