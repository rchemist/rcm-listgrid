// @rcm/listgrid-next — Next.js adapter for RouterServices.
//
// Consumers import from '@rcm/listgrid/next' and wire into <RouterProvider>:
//   import { nextRouterServices } from '@rcm/listgrid/next';
