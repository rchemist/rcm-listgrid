// POST /api/staff (create) + DELETE /api/staff (bulk delete, body
...
// makeCollectionHandlers' POST): staff previously had NO collection DELETE
// at all, the exact defect this task fixes.
import { staffStore } from '../../../lib/mock-backend/collabo';
import { makeCollectionHandlers } from '../../../lib/mock-backend/crud-routes';

export const { POST, DELETE } = makeCollectionHandlers(staffStore);
