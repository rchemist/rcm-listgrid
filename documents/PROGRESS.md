...
- [x] **EF3 [O] initializeFormStore 파이프** ✅ `98f956f` · build-after-hooks+useEntityFormInitializer+hydrate dotted 수정 · +16 unit(1176 green)·E2E 5/5·deviations 2→§Needs Review · [detail](./progress-archive/phase-e-track-tasks.md)
