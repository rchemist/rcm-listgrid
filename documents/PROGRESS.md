...
**Last updated**: 2026-07-11 (**W2-6 완료** — list 훅 축(onBeforeListFetch/onAfterListFetch, §4.1): EntityForm 2훅+list-store fetch() 재작성(setSearchForm 주입·per-fetch·postFetch 보존). sonnet delegate→opus 검증(full gate green·**1931 unit**·계수 37/46/**175** PASS). **Next=W2-7 useEntityForm(react)**.)
...
- [~] **W2 훅+컨트롤러** (착수 6/8 — W2-1~6 ✅, 다음 W2-7) — onInit/InitContext·FormRuntime/FormController·messages·serializeValue·list 훅 · Spec §4·§6 · CAP-04·11·14·21·25·26 · [waves §W2](./plans/entityform-api-implementation-waves.md) (**hot-file 순차 — fan-out 금지**)
