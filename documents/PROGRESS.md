...
**Last updated**: 2026-07-11 (**W2-1 완료** — 훅 개명·onInit 통합·InitContext·EF7 값세터→ctx.values·initialMeta seam. sonnet delegate→opus 검증(full gate green·1887 unit·계수 27/46/161 PASS)+리뷰교정 1(renderType id-based). **Next=W2-2 FormMutator getRenderType/getSession**.)
...
- [~] **W2 훅+컨트롤러** (착수 1/8 — W2-1 ✅, 다음 W2-2) — onInit/InitContext·FormRuntime/FormController·messages·serializeValue·list 훅 · Spec §4·§6 · CAP-04·11·14·21·25·26 · [waves §W2](./plans/entityform-api-implementation-waves.md) (**hot-file 순차 — fan-out 금지**)
