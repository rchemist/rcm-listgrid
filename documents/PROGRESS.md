...
**Last updated**: 2026-07-11 (**W2-7 완료** — useEntityForm(react §7): initializer 합성+controller 동봉·college 페이지 controller.save 이관·initializer @deprecated. opus 리뷰교정 1(validateOnChange 배선). sonnet delegate→opus 검증(full gate green·**1934 unit**·계수 37/49/175 PASS). **Next=W2-8 changeSelectOptions 레이스 fix(W2 마지막)**.)
