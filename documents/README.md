...
| 순위 | 경로 | 내용 | 성격 |
|---|---|---|---|
| 1 | `adr/` | 아키텍처 결정 기록(ADR-0001~0008 — 0008이 실행 전략=재기초). **구현 세션은 여기서 시작한다** | 규범 (살아있음) |
| 2 | `prd/` | 제품 요구·포지셔닝·릴리스 전략 + **개념 헌장**(concept-charter.md — 재기초에서 보존할 개념 C1~C9의 단일 명세) | 규범 (살아있음) |
