...
[@rchemist/listgrid API Reference](../../README.md) / [listgrid](../README.md) / AbstractManyToOneField

# Abstract Class: AbstractManyToOneField\<TSelf, TValue, TForm\>

Defined in: [listgrid/components/fields/abstract/AbstractManyToOneField.tsx:74](https://github.com/rchemist/rcm-listgrid/blob/b27ec79868acd9c1ed21321f6571558c5fffa2f8/src/listgrid/components/fields/abstract/AbstractManyToOneField.tsx#L74)
...
- [`ManyToOneField`](ManyToOneField.md)
...
> **new AbstractManyToOneField**\<`TSelf`, `TValue`, `TForm`\>(`name`, `order`, `manyToOne`): `AbstractManyToOneField`\<`TSelf`, `TValue`, `TForm`\>

Defined in: [listgrid/components/fields/abstract/AbstractManyToOneField.tsx:93](https://github.com/rchemist/rcm-listgrid/blob/b27ec79868acd9c1ed21321f6571558c5fffa2f8/src/listgrid/components/fields/abstract/AbstractManyToOneField.tsx#L93)
...
`AbstractManyToOneField`\<`TSelf`, `TValue`, `TForm`\>
