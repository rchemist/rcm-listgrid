...
[@rchemist/listgrid API Reference](../../README.md) / [listgrid](../README.md) / CustomValidation

# Class: CustomValidation

Defined in: [listgrid/validations/CustomValidation.ts:5](https://github.com/rchemist/rcm-listgrid/blob/b27ec79868acd9c1ed21321f6571558c5fffa2f8/src/listgrid/validations/CustomValidation.ts#L5)
...
> **new CustomValidation**(`id`, `validateFunction`, `errorMessage?`): `CustomValidation`

Defined in: [listgrid/validations/CustomValidation.ts:12](https://github.com/rchemist/rcm-listgrid/blob/b27ec79868acd9c1ed21321f6571558c5fffa2f8/src/listgrid/validations/CustomValidation.ts#L12)
...
(`entityForm`, `value`, `message?`) => `Promise`\<[`ValidateResult`](ValidateResult.md)\>
...
> **validateFunction**: (`entityForm`, `value`, `message?`) => `Promise`\<[`ValidateResult`](ValidateResult.md)\>

Defined in: [listgrid/validations/CustomValidation.ts:6](https://github.com/rchemist/rcm-listgrid/blob/b27ec79868acd9c1ed21321f6571558c5fffa2f8/src/listgrid/validations/CustomValidation.ts#L6)
...
Defined in: [listgrid/validations/CustomValidation.ts:25](https://github.com/rchemist/rcm-listgrid/blob/b27ec79868acd9c1ed21321f6571558c5fffa2f8/src/listgrid/validations/CustomValidation.ts#L25)
