...
[@rchemist/listgrid API Reference](../../README.md) / [listgrid](../README.md) / ListableFormField

# Abstract Class: ListableFormField\<TSelf, TValue, TForm\>

Defined in: [listgrid/components/fields/abstract/ListableFormField.tsx:118](https://github.com/rchemist/rcm-listgrid/blob/b27ec79868acd9c1ed21321f6571558c5fffa2f8/src/listgrid/components/fields/abstract/ListableFormField.tsx#L118)

## Extends

- [`FormField`](FormField.md)\<`TSelf`, `TValue`, `TForm`\>

## Extended by

- [`NumberField`](NumberField.md)
- [`YearField`](YearField.md)
- [`MonthField`](MonthField.md)
- [`TelephoneNumberField`](TelephoneNumberField.md)
- [`PhoneNumberField`](PhoneNumberField.md)
- [`FileField`](FileField.md)
- [`ImageField`](ImageField.md)
- [`ColorField`](ColorField.md)
- [`ColorPresetField`](ColorPresetField.md)
- [`BirthdayField`](BirthdayField.md)
- [`OptionalField`](OptionalField.md)
- [`AbstractManyToOneField`](AbstractManyToOneField.md)
- [`AbstractDateField`](AbstractDateField.md)
- [`CheckButtonValidationField`](CheckButtonValidationField.md)
...
> **new ListableFormField**\<`TSelf`, `TValue`, `TForm`\>(`name`, `order`, `type`): `ListableFormField`\<`TSelf`, `TValue`, `TForm`\>
...
`ListableFormField`\<`TSelf`, `TValue`, `TForm`\>
