...
[@rchemist/listgrid API Reference](../../README.md) / [listgrid](../README.md) / OptionalField

# Abstract Class: OptionalField\<TSelf, TValue, TForm\>

Defined in: [listgrid/components/fields/abstract/OptionalField.tsx:55](https://github.com/rchemist/rcm-listgrid/blob/b27ec79868acd9c1ed21321f6571558c5fffa2f8/src/listgrid/components/fields/abstract/OptionalField.tsx#L55)
...
- [`MultipleOptionalField`](MultipleOptionalField.md)
- [`BooleanField`](BooleanField.md)
- [`SelectField`](SelectField.md)
- [`CustomOptionField`](CustomOptionField.md)
...
> **new OptionalField**\<`TSelf`, `TValue`, `TForm`\>(`name`, `order`, `type`): `OptionalField`\<`TSelf`, `TValue`, `TForm`\>
...
`OptionalField`\<`TSelf`, `TValue`, `TForm`\>
